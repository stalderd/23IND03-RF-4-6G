...
outputfileNameSupplement = 'P1_02';
...
summaryFreqMinExt_GHz = .00001;
summaryFreqMinNom_GHz = .01;
summaryFreqMaxNom_GHz = 1;
summaryFreqMaxExt_GHz = 3;
...
for i1 = 1:nPower
    for i2 = 1:nStepAtt
        for i3 = 1:nFreq
            ...
            % 'S2,1', 'S1,2', 'a1_p1', 'a2_p2'
            if port1
                aypy_all(i1, i2, i3, :) = d.Data(:, 3);
                sxy_all(i1, i2, i3, :) = d.Data(:, 1);
            else
                aypy_all(i1, i2, i3, :) = d.Data(:, 4);
