...
# Freqiencies must already be set correctly
...
name = 'StepAtt60dB(f-m)_TH61350341_01' # Measurement file base name
...
mode = VnaParameter.SParameterMatrix(Array[int]([1, 2]))
